...
{
    /**
     * List all published exams the student has results for, with a summary per exam.
     */
    public function index(): View
    {
        ...
        return view('app.student.results.index', compact('student', 'exams'));
    }

    /**
     * Detailed subject-wise mark sheet for a single published exam.
     */
    public function show(Exam $exam): View
    {
        ...
        // Build per-subject rows with max/passing marks and pass status.
        ...
        return view('app.student.results.show', compact('student', 'exam', 'rows', 'summary'));
    }

    /**
     * Fetch exam schedules for the given exams and class, keyed by "examId-subjectId".
     */
    ...
    /**
     * Aggregate totals, percentage, overall grade and pass/fail for a set of results.
     */
