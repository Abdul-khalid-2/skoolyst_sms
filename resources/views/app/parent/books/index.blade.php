        ...
        <div class="row" style="margin-bottom: 15px;">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <h3 style="margin: 0; line-height: 34px;">
                    <i class="fa fa-book"></i> Library Books
                </h3>
                <small class="text-muted">Borrowing history for linked children</small>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    ...
                    @if($issues->isEmpty())
                        <p class="text-muted text-center" style="padding: 30px 0;">No book issues found.</p>
                    @else
